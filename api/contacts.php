...
<tr class="border-b dark:border-gray-700">
    ...
    <td class="px-4 py-3 flex items-center justify-end">
        <div class="flex items-center space-x-4">
            ...
            <button hx-post="/api/delete.php?id=<?php echo $row['id'];?>" hx-target="#alert-delete" hx-trigger="click" hx-confirm="are you sure you want to delete this?" data-modal-target="delete-modal" data-modal-toggle="delete-modal"
