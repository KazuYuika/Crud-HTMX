...
if($result = $conn->query($sql)){
    ...
    header("HX-Location: /index.php?success=1");
    ...
    if($result = $conn->query($sql)){
        echo '<div id="alert-border-4" class="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-300 dark:bg-gray-800 dark:border-yellow-800" role="alert">
